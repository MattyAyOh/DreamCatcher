...
- (void)resetNavButtons {
    ...
    if (_menuFlags.canShowLeft) {
        ...
        UIImage *myImage = [UIImage imageNamed:@"Menu"];
        myImage = [myImage imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        
        UIBarButtonItem *button = [[UIBarButtonItem alloc] initWithImage:myImage style:UIBarButtonItemStylePlain target:self action:@selector(showLeft:)];
    ...
    if (_menuFlags.canShowRight) {
        ...
        UIBarButtonItem *button = [[UIBarButtonItem alloc] initWithImage:myImage style:UIBarButtonItemStylePlain  target:self action:@selector(showRight:)];
